...
@WebServlet(name = "ServletVerPeriodicosParaActualizar", urlPatterns = {"/verperiodicosactualizar"})
public class ServletVerPeriodicosParaActualizar extends HttpServlet {
    ...
    private void hacerAlgo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("veractualizarperiodicos.jsp").forward(request,response);
    }
